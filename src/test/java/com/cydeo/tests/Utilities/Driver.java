...
public class Driver {
    ...
    private static WebDriver driver; // default value of driver is null
    ...
    public static void closeDriver(){
        ...
        if (driver != null){
            ...
            driver.quit();// This line will terminate the currently existing driver completely. It will be not exist going forward
